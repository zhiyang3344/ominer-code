...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, normalizer=None, num_in_classes=200, num_out_classes=0, num_v_classes=0, zero_init_residual=False,
                 groups=1, width_per_group=64, replace_stride_with_dilation=None,
                 norm_layer=None, output_real_only=False):
