...
class ResNeXt(nn.Module):
    def __init__(self, num_blocks, cardinality, bottleneck_width, normalizer=None, num_in_classes=10, num_out_classes=0, num_v_classes=0, output_real_only=False):
